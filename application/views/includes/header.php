...
<body >
	...
	<div class="responsive-header">
		<div class="mh-head first mm-sticky mh-btns-left mh-btns-right mh-sticky" style="">
			...
			<span class="mh-text">
				<a href="<?php echo base_url() ?>Posts" title=""><img src="<?php echo base_url()?>assets/images/logo.svg" width="50%" alt=""></a>
			</span>
	...
	<div class="topbar stick" style="">
		<div class="logo">
			<a title="" href="<?php echo base_url() ?>Posts"><img src="<?php echo base_url()?>assets/images/logo.svg"  width="50%" alt=""></a>
		</div>
		<div class="top-area">
